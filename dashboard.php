...
<div class="row">
	...
	<div class="col-md-4">
		<div class="card">
		  <div class="cardHeader" style="background-color:#66CDAA;">
...
<?php  if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading"> <i class="glyphicon glyphicon-calendar"></i> Total sale(Customer)</div>
				...
				<table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:20%;">Orders in Ringgit Malaysia</th>
			  		</tr>
			  	</thead>
			  	<tbody>
...
<html>
  ...
  <body>
    <div class="chart-container", align="center", style="margin-left:400px;margin-top: 10px;" >
