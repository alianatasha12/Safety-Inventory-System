    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	         ...
	         <div class="form-group">
	        	<label for="expired" class="col-sm-3 control-label">Expired Date: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="date" class="form-control" id="expired" placeholder="Expired Date" name="expired" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	     	        
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editRate" placeholder="Price" name="editRate" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	     	        
			        ...
			        <div class="form-group">
			        	<label for="editexpired" class="col-sm-3 control-label">Expired Date: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="date" class="form-control" id="editexpired" placeholder="Expired Date" name="editexpired" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->		         	        
